    ...
    var billData = {
        ...
        billCtrl = {
            ...
            reInit: function(data) {
                ...
                /* TextInput组件初始化数据注入 */
                /* TextInput组件初始化数据注入 */
                $("input[name=radiogroup-grademgr]").val("").data("value", "");
                $("input[name=radiogroup-tracestate]").val("").data("value", "");
                $("input[name=textinput-cuname]").val(data.cusName);
                $("input[name=textinput-tracer]").val(data.follower);
            ...
            init: function(data) {
                ...
                $("button[data-op=step1done]").tap(function() {
                    ...
                    window.location.href = DDCtrl.navWithColor(s + "?do=0&cid=" + billData.cid + "&bid=" + billData.bid, "FF42AAB3");
                });
            }
        },
        OMS = {
