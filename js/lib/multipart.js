...
;(function(root, $) {
    ...
    root.Multipart = root.Multipart || (function() {
        ...
        var prototype = Multipart.prototype,
            constructor = Multipart;

        function Multipart() {
            this.boundary = "Multipart-" + (new Date()).getTime() + "-" + Math.random();
            this.data = [];
        }
        prototype.append = function(name, val, filename, type) {
            this.data.push({
                name: name,
                val: val,
                filename: filename,
