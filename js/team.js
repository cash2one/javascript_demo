...
function setLoudouChart(vals,title,war,qy,leix){
    var colors =['#e4527c','#50a5cf','#fb9128','#ea5751','#6acccb','#3cb67f','#3db780','#606060'],
        ...
        categories = ['已签客户', '订金客户', '重点客户', '意向客户', '客户资源'],
        name = title+'销售漏斗图';
    var qy = qy-1;
    var data = new Array();
    var list = new Array();
    ...
    var number = 0;
    console.log(vals);
    $.each(Object.keys(vals), function(i,val){
        number = number + vals[val];
        data.push({
            y:vals[val],
            color:colors[i],
...
//销售日报
function setSalesDailyChart(vals,title,war,qy,leix){
    var colors =['#e4527c','#50a5cf','#fb9128','#ea5751','#6acccb','#3cb67f','#3db780','#606060'],
        // categories = ['待理单', '已签已回', '已签未回', '重点跟进', '能签能回', '冲击客户','推进中', '已死客户'],
        categories = ['潜在客户跟进', '外拓', '转介绍', '场开', '自然到访', '预约到访', '会员保有'],
        name = title+'销售日报';
    var qy = qy-1;
    var data = new Array();
    var list = new Array();
...
//私教日报
function setPrivateDailyChart(vals,title,war,qy,leix){
    var colors =['#e4527c','#50a5cf','#fb9128','#ea5751','#6acccb','#3cb67f','#3db780','#606060'],
        // categories = ['待理单', '已签已回', '已签未回', '重点跟进', '能签能回', '冲击客户','推进中', '已死客户'],
        categories = ['收费课预约', '收费课上课', 'POS', 'W1', 'W2', 'RX'],
        name = title+'私教日报';
    var qy = qy-1;
    var data = new Array();
    var list = new Array();
