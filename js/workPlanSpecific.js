$(function(){
    ...
    var OMS = {
        ...
        refreshData: function(){
            ...
            var month=localStorage.getItem('team.workPlanSpecific.dat') || defaultValue;
            OMS.getWorkPlanSpecific(month,'month', [], []);
        },
        getData: function(){
            $("#msg").html("正在加载中...")
            $("#msg").show();
        ...
        initTable: function(){
                        ...
                        onSuccess : function(result) {
                            dd.biz.util.datepicker({
                                ...
                                onSuccess: function(result) {
                                    ...
                                    localStorage.setItem('team.workPlanSpecific.dat', monthvalue);
                                    //重置 rightMenu
                                    resetRight(monthvalue);
                                    //加载数据
                                    OMS.getWorkPlanSpecific(monthvalue,dayType,[],[]);
                                }
                            });
                        }
                    });
            ...
            OMS.getWorkPlanSpecific(month,dayType, [], []);
        },
        getWorkPlanSpecific: function (day, dayType, userList, userStatus) {
        ...
        setTableData: function (data) {
            ...
            for(var i in tableData){
                ...
                if(tableData[i].isClick==1){
                    dept='<a href="workPlanSpecific.html?orgid='+tableData[i].id+'" >'+dept+'</a>';
                }
            ...
            var head = '<thead>\
            <tr>\
            <th style="max-width:100px;" class="table-title">部门/人员</th>';
